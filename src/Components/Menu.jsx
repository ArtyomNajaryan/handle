...
export let Menu = () => {
  ...
  return <div>
    ...
    <nav className="fixed w-full z-40  bg-white border-b border-gray-100">
          ...
          <div className="flex-1 flex items-center justify-between">
            ...
            <div className="hidden sm:hidden md:hidden lg:block sm:ml-6">
              <div className="flex justify-center  text-lg font-medium 	space-x-4">
                ...
                <Link to="/shop"
                  className="px-3 py-2 hover:text-yellow-400">SHOP</Link>
                <Link to="/"
                  className="px-3 py-2 hover:text-yellow-400" aria-current="page">BLOG</Link>
                <Link to="/"
                  className="px-3 py-2 hover:text-yellow-400">ABOUT</Link>
                <Link to="/contuct"
                  className="px-3 py-2 hover:text-yellow-400">CONTUCT</Link>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <Link to="cart/" className="px-5">
                <svg xmlns="http://www.w3.org/2000/svg" className=" h-6 w-6 hover:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div
        className="hidden bg-gray-900 mx-4 rounded-2xl ease-in-out absolute text-center left-0 right-0 top-20 text-white shadow-lg shadow-gray-600/40 "
        id="mobile-menu">
