    ...
    <section className=" bg-gray-50">
      <div className="flex justify-between max-w-7xl mx-auto py-24 md:py-24 lg:py-36   px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-1/3 flex items-center text-left">
          <div>
            <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold">FURNITURE GALLERY</h1>
            <p className="py-5 text-sm md:text-md lg:text-md text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus repellendus, culpa suscipit ut provident earum.</p>
            <button className="border-2 ease-in duration-300 border-gray-900 py-1 px-2 md:py-2 md:px-3 lg:py-2 lg:px-3 text-sm md:text-md lg:text-md  hover:bg-gray-900 hover:text-white">
    ...
    <section>
      <div className="max-w-7xl mx-auto py-8 md:py-16 lg:py-24   px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center ">
          <div className="w-1/3 mx-5 flex items-center">
            <h3 className="absolute mx-10 ">lkjbvc</h3>
          ...
          <div className="tex-end w-1/3 mx-5">
